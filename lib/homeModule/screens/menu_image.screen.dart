...
class MenuImageScreen extends StatefulWidget {
  final MenuImageArguments args;

  const MenuImageScreen({super.key, required this.args});

  @override
  State<MenuImageScreen> createState() => MenuImageScreenState();
}

class MenuImageScreenState extends State<MenuImageScreen> {
  double dW = 0.0;
  double dH = 0.0;
